...
class run_software:
    ...
    def run_pear(self, pear_arg, fastq_f, fastq_r, output_dir, sample_name):
        """
        PEAR usage: ./pear -f <fastq_f>, -r <fastq_r> -o <output_base_name>
        """
        args = [pear_arg, '-f', fastq_f, '-r', fastq_r, '-o', output_dir+sample_name]
    ...
    def batch_run_pear(self, pear_arg, sample_dir, output_dir):
        sample_files = os.listdir(sample_dir)
        sample_files.sort()
            ...
            if len(samples) != len(fastq_f):
                ...
                while sample_counter < len(samples):
                    if re.search(samples[sample_counter], fastq_f[sample_counter]) and re.search(samples[sample_counter], fastq_r[sample_counter]):
                        ...
                        self.run_pear(pear_arg, sample_dir+fastq_f[sample_counter], sample_dir+fastq_r[sample_counter], output_dir, samples[sample_counter])
                    sample_counter += 1    
    ...
    def run_breseq(self, breseq_arg, ref_dir, input_dir, sample_name, output_dir, polymorphism_min = '5 ', ref_genome1 = 'dv.gbk', ref_genome2 = 'mp.gbk', ref_genome3 = 'megaplasma.gbk'):
        """
    ...
    def batch_run_breseq(self, breseq_arg, ref_dir, pear_results_dir, breseq_output_dir):
    ...
    def run_gdtools_compare(self, gdtools_arg, *samples, breseq_dir, ref_dir, ref_genome1 = 'dv.gbk', ref_genome2 = 'mp.gbk', ref_genome3 = 'megaplasma.gbk'):
        ...
        args = [gdtools_arg, 'COMPARE', '-o', output_file, '-r', ref1, '-r', ref2,'-r', ref3, ancestor]
    ...
    def batch_run_blastn_remote(self, sample_name, breseq_dir = '/home/NETID/ymseah/Projects/Low_Mapping_in_breseq/results/breseq_results/',
                                blast_out_dir = '/home/NETID/ymseah/Projects/Low_Mapping_in_breseq/results/blast_results/'):
        fastq_filepath = breseq_dir + sample_name + '_breseq/data/'
        ...
        for fasta in fasta_filenames:
            self.run_blastn_remote(fastq_filepath, fasta, blast_out_dir)
